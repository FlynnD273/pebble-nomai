const gaugeOptions = ["Watch battery level", "Phone battery level", "24-hour progress", "24-hour progress (inverted)", "Temperature", "Rain forecast"].map((x, i) => { return { label: x, value: i + "" } });
module.exports = [
	{
		type: "heading",
